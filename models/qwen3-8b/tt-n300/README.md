# Qwen3-8B — Tenstorrent N300 (Wormhole, TP=2)

Serves [Qwen/Qwen3-8B](https://huggingface.co/Qwen/Qwen3-8B) via the Tenstorrent vLLM backend on a **single N300** card (2× Wormhole B0 dies) using tensor parallelism (TP=2).

See also: [`../tt-n150/`](../tt-n150/) · [`../1x16gb/`](../1x16gb/) (NVIDIA)

## Requirements

| | |
|---|---|
| **Device** | 1× Tenstorrent N300 (2× Wormhole B0) |
...
```bash
kubectl apply -k https://github.com/siderolabs/ai-on-k8s//models/qwen3-8b/tt-n300
```

Or from a local clone:

```bash
kubectl apply -k models/qwen3-8b/tt-n300/
```
